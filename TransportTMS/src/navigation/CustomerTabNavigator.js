...
const CustomerTabNavigator = () => (
  <Tab.Navigator screenOptions={({ route }) => ({ headerShown: false, tabBarActiveTintColor: '#2563EB', tabBarInactiveTintColor: '#9CA3AF', tabBarStyle: { paddingBottom: 6, height: 60 }, tabBarIcon: ({ focused }) => { const icons = { Home: '🏠', Booking: '🎫', Trips: '🗺️', Profile: '👤' }; return <Text style={{ fontSize: focused ? 22 : 18 }}>{icons[route.name]}</Text>; } })}>
