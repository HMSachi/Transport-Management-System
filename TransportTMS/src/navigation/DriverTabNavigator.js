...
const DriverTabNavigator = () => (
  <Tab.Navigator screenOptions={({ route }) => ({ headerShown: false, tabBarActiveTintColor: '#059669', tabBarInactiveTintColor: '#9CA3AF', tabBarStyle: { paddingBottom: 6, height: 60 }, tabBarIcon: ({ focused }) => { const icons = { Home: '🏠', Requests: '📋', Trip: '🚌', Bus: '🔧' }; return <Text style={{ fontSize: focused ? 22 : 18 }}>{icons[route.name]}</Text>; } })}>
